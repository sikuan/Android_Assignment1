...
public class ChatService extends Service {
    ...
    public static final int CMD_SEND_CONNECT_ERROR = 67;
    public static final int CMD_SEND_RANDOM_ID = 0;
    ...
    private void handleData(Bundle data) {
        ...
        }else if (command == CMD_SEND_CONNECT_ERROR){
            notificationDecorator.displaySimpleNotification("Connect Error:"+CMD_SEND_CONNECT_ERROR, "Disconnecting");
            //stopSelf();
